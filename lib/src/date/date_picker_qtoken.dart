...
///    [DatePickerQtoken].
///
class DatePickerQtoken extends StatefulWidget {
  ...
  /// The amount of padding to be added around the [DatePickerQtoken].
  ...
  @override
  State<DatePickerQtoken> createState() => _DatePickerQtokenState();
}

class _DatePickerQtokenState extends State<DatePickerQtoken> {
  ...
  @override
  void didUpdateWidget(covariant DatePickerQtoken oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final styleSelectedCellDecoration = widget.selectedCellDecoration?.copyWith(
