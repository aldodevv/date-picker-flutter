...
///    [DatePickerQib].
///
class DatePickerQib extends StatefulWidget {
  ...
  DatePickerQib({
    ...
    this.slidersColor = ColorsApp.blue80,
    this.slidersSize = 24,
    this.highlightColor = ColorsApp.blue10,
    this.splashColor = ColorsApp.blue10,
  ...
  /// The amount of padding to be added around the [DatePickerQib].
  ...
  @override
  State<DatePickerQib> createState() => _DatePickerQibState();
}

class _DatePickerQibState extends State<DatePickerQib> {
  ...
  @override
  void didUpdateWidget(covariant DatePickerQib oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final styleSelectedCellDecoration =
        widget.selectedCellDecoration?.copyWith(
      color: ColorsApp.blue80,
    );

    final styleSelectedCell = widget.selectedCellTextStyle?.copyWith(
          ...
          child: MonthPicker(
            ...
            onDateSelected: (selectedMonth) {
              ...
              setState(() {
                ...
                _selectedDate = clampedSelectedMonth;
          ...
          child: YearsPicker(
            ...
            onDateSelected: (selectedYear) {
              ...
              setState(() {
                ...
                _selectedDate = clampedSelectedYear;
                _pickerType = PickerType.months;
              });
            },
          ),
